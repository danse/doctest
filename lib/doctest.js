...
(function() {
  var CoffeeScript, doctest, escodegen, esprima, fetch, q, rewrite, rewriteCoffee, rewriteJava, _,
    __slice = [].slice;
  ...
  rewrite = function(input, type) {
    switch (type) {
      case 'coffee':
        return rewriteCoffee(input);
      case 'js':
        return rewriteJava(input);
    }
  };

  rewriteJava = function(input) {
